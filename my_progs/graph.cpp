...
class Adjacency_list
{
      ...
      void makeList()
      {
           ...
           Node* temp_edge=NULL;
           int n_no;//temporary pointer for moving over edge nodes of a particular main node
           for(int i=0;i<num_nodes;i++)
           {
                   ...
                   if(i==0)
                   {
                           head=new Node(n_no);//make first node                          
                   ...
                   {
                       temp_node->next_node=new Node(n_no);//make next node
