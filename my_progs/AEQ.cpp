...
void SquareMatrixMultiply(long long int A[10][10],long long int B[10][10],long long int C[10][10])
{
     int n=10;
    for(int i=0;i<n;i++)
    {
...
void power(long long int A[10][10],long long int B[10][10],long long int n)
{
     int k=10;
     if(n==1)
     {
